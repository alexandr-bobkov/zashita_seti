...
Атака методом Brute-force с помощью словарей была успешно и в автоматическом режиме ликвидирована благодаря концепции эшелонированной защиты (Defense in Depth) на защищаемом сервере Debian 13:
